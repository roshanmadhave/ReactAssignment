...
function Administrator() {
 ...
 //  const [enteredComplete, setenteredcomplete] = useState<string>('')
    ...
    let trueVacci = enteredVaccine!== "none";
                       ...
                       <div className="form-body">
                           ...
                           <div className="form-group">
                               ...
                               <select name="vaccine" id="vaccine" value={enteredVaccine} className="form-control" onChange={vaccineChangeHandler}>
                                   <option value="none" >Select Doses</option>
                                    <option value="first">First Dose</option>
                                    <option value="second">Second Dose</option>
                                </select>
                                { trueVacci && <p className="alert alert-danger">This is a mandatory field</p>}
                           </div>
                           ...
                           {/* givenAt :  */}
                           <div className="form-group">
                               <label htmlFor="givenat">Taken At : </label>
                               <input type="text" 
                               name="givenat" placeholder="Enter Hospital Name" value={enteredHospital} onChange={givenAtChangeHandler}
                               className="form-control"/>
                           </div>
                           <br />
                           {/* buttons */}
